...
import { deleteUsers, loadUsers, loadAdmins ,loadDeliveryBoys} from '../../redux/action';
...
const DeliveryBoys = () => {
  ...
  return (
    <div >
      ...
      <Button variant="contained" onClick ={()=> history.push("/app/user/addUser")}>Add Delivery Boys</Button>
      </div>
